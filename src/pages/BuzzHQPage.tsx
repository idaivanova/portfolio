      ...
      <BumblebeeCursorWrapper>
        ...
        <ScrollReveal>
          <section id="intro" className="mb-16">
            <div className="flex flex-col gap-8">
              ...
              {/* Description */}
              <div className="text-foreground/80 text-lg leading-relaxed max-w-2xl">
                {heroData.description}
              </div>
              
              {/* Interactive hint */}
              <div className="p-4 bg-muted/30 rounded-lg border border-border max-w-md">
        ...
        <ScrollReveal>
          <section id="behaviors" className="mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-2">{behaviorsData.title}</h2>
            <p className="text-foreground/60 mb-8">{behaviorsData.subtitle}</p>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-foreground mb-2">{behavior.name}</h3>
                      <p className="text-foreground/60 text-sm mb-3">{behavior.description}</p>
        ...
        <ScrollReveal>
          <section id="stats" className="mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-2">{statsData.title}</h2>
            <p className="text-foreground/60 mb-8">{statsData.subtitle}</p>
        ...
        <ScrollReveal>
          <section id="features" className="mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-2">{featuresData.title}</h2>
            <p className="text-foreground/60 mb-8">{featuresData.subtitle}</p>
        ...
        <ScrollReveal>
          <section id="insights" className="mb-16">
            <h2 className="text-3xl font-bold text-foreground mb-8">{insightsData.title}</h2>
            
            <div className="space-y-4">
              {insightsData.insights.map((insight, index) => (
                <div 
                  key={index} 
                  className="p-6 bg-muted/50 rounded-lg border-l-4 border-accent"
                >
